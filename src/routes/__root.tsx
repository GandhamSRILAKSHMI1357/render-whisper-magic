  ...
  head: () => ({
    meta: [
      ...
      { title: "Aurum — Cinematic AI Studio" },
      {
        name: "description",
        content:
          "Aurum is a cinematic AI studio. Generate scripts, dialogue, song lyrics, images, shorts and long-form video concepts from a single prompt.",
      },
      { name: "author", content: "Aurum" },
      { property: "og:title", content: "Aurum — Cinematic AI Studio" },
      { property: "og:description", content: "From prompt to picture, score and screenplay. One studio." },
